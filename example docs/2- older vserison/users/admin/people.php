...
<html lang="en">
    ...
    <body class="bg-light">
        ...
        <div class="container">
            <div class="card mb-2">
                <div class="card-body">
                    <h1 class="card-title text-center mb-2">Select Zone</h1>
                    ...
                    <form method="POST">
                        ...
                        <div class="text-center mb-2">
                            <button type="submit" onclick="updateZone()" class="btn btn-success btn-lg">Update&nbsp;&nbsp;<i class="bi bi-box-arrow-in-right"></i></button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div id = "site_content" class="container">
            <div class="card text-center">
                <div class="card-body">
                    <h1 id = "zone_title" class="card-title mb-4"><?php echo $_SESSION["zone_ad"]; ?></h1>
        ...
        <div data-bs-backdrop="static" id="editContactModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <form method="POST" id="editContactForm" onsubmit="return confirm('Are you sure you want to save edits?');">
                                ...
                                <div class="row justify-content-center g-1">
                                    ...
                                    <a id="deleteContactButton" class="btn btn-danger btn-lg col-sm-auto mx-1" onclick="return confirm('Are you sure you want to delete this contact?');"><span class="d-none d-sm-inline">Delete&nbsp;&nbsp;</span><i class="bi bi-trash-fill"></i></a>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <script>
            ...
            // update zone
            function updateZone(){
                xhttp.open("GET", "updateZone.php?", true);
                xhttp.send();   
            }
