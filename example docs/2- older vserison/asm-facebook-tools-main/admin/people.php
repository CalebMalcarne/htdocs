            ...
            <div class="navbar navbar-light bg-white">
                <div class="container">
                    ...
                    <div class="nav nav-pills">
                        ...
                        <a href="tools.php" class="nav-link text-dark"><span class="d-none d-md-inline">Tools&nbsp;&nbsp;</span><i class="bi bi-tools"></i></a>
                    </div>
            ...
            <div class="navbar navbar-light bg-white">
                <div class="container">
                    ...
                    <div class="nav nav-pills">
                        ...
                        <a class="nav-link text-dark"><span class="d-none d-md-inline">Tools&nbsp;&nbsp;</span><i class="bi bi-tools"></i></a>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="card shadow">
                        <div class="card-header text-center bg-dark text-white">
                            <h1 class="card-title">Select Zone</h1>
                        </div>

                        <div class="card-body mx-3 my-3">
                            <form method="POST" action="php/updateZone.php">
                                <div class="mb-4">
                                ...
                                <div class="row">
                                    <div class="col d-flex justify-content-center">
                                        <button type="submit" class="btn btn-success btn-lg">Update <i class="bi bi-check2"></i></button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div data-bs-backdrop="static" id="newPersonModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <form method="POST" class="mb-3" onsubmit="return confirm('Are you sure you want to create this person?');" action="/php/editData.php">
                                <div class="mb-3">
        ...
        <div data-bs-backdrop="static" id="editPersonModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <form method="POST" class="mb-3" onsubmit="return confirm('Are you sure you want to save these edits?');" action="/php/editData.php">
        ...
        <div data-bs-backdrop="static" id="newContactModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <form method="POST" onsubmit="return confirm('Are you sure you want to add this contact?');" action="/php/editData.php">
        ...
        <div data-bs-backdrop="static" id="editContactModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <form method="POST" onsubmit="return confirm('Are you sure you want to save edits?');" action="/php/editData.php">
