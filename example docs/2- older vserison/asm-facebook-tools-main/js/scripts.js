...
function updateCheck(check, id, type, path) {
    if (check.checked) {
        if (type == "int") {
            ...
            if (okToProceed) {
                location.href = "../php/updateCheck.php?id=" + id + "&type=interested&value=1";
            } else {
                check.checked = false;
            }
        } else if (type == "ref") {
            ...
            if (okToProceed) {
                location.href = "../php/updateCheck.php?id=" + id + "&type=referred&value=1";
            } else {
                check.checked = false;
            }
        } else if (type == "dnc") {
            ...
            if (okToProceed) {
                location.href = "../php/updateCheck.php?id=" + id + "&type=dnc&value=1";
            } else {
                check.checked = false;
            }
        }
        ...
        if (type == "int") {
            ...
            if (okToProceed) {
                location.href = "../php/updateCheck.php?id=" + id + "&type=interested&value=0";
            } else {
                check.checked = true;
            }
        } else if (type == "ref") {
            ...
            if (okToProceed) {
                location.href = "../php/updateCheck.php?id=" + id + "&type=referred&value=0";
            } else {
                check.checked = true;
            }
        } else if (type == "dnc") {
            ...
            if (okToProceed) {
                location.href = "../php/updateCheck.php?id=" + id + "&type=dnc&value=0";
            } else {
                check.checked = true;
            }
        }
