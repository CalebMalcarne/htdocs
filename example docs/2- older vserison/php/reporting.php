            ...
            <div class="navbar navbar-light bg-white">
                <div class="container">
                    ...
                    <div class="nav nav-pills">
                        <a href="<?php echo "../users/display/people.php" ?>" class="nav-link text-dark"><span class="d-none d-sm-inline">People&nbsp;&nbsp;</span><i class="bi bi-people-fill"></i></a>
                        <a href="<?php echo "../users/display/insights.php" ?>" class="nav-link text-dark"><span class="d-none d-sm-inline">Insights&nbsp;&nbsp;</span><i class="bi bi-graph-up"></i></a>
