            ...
            <div class="navbar navbar-light bg-white">
                <div class="container">
                    ...
                    <div class="nav nav-pills">
                        ...
                        <a class="nav-link active bg-dark"><span class="d-none d-md-inline">Logs&nbsp;&nbsp;</span><i class="bi bi-file-earmark-text"></i></a>
                    </div>
        ...
        <script>
            ...
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById("LogTableBody").innerHTML = this.responseText;
                }
            };

            xhttp.open("GET", "php/loadlogs.php", true);
            xhttp.send();
        </script>
