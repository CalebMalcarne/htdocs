            ...
            <div class="navbar navbar-light bg-white">
                <div class="container">
                    ...
                    <div class="nav nav-pills">
                        ...
                        <a class="nav-link active bg-dark"><span class="d-none d-md-inline">Password change&nbsp;&nbsp;</span><i class="bi bi-tools"></i></a>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body mt-2 mx-3">
                            ...
                            <form method="POST" onsubmit="return confirm('Are you sure you want to change the password?');">
                                <div class="mb-3">
                                    <label for="zone" class="form-label">Options</label>
